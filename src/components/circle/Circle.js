    ...
    return (
        <div className="mainCircle">
            ...
            <div className="circle3">
                <Link to="/">
                    <object data="/media/darkGrey.svg" width="58" height="58"></object>
                </Link>
                <Link to="/">
                    <object data="/media/lightGrey.svg" width="58" height="58"></object>
                </Link>
                <Link to="/">
                    <object data="/media/white.svg" width="58" height="58"></object>
                </Link>
                <Link to="/">
                    <object data="/media/red.svg" width="58" height="58"></object>
                </Link>
                <Link to="/">
                    <object data="/media/blue.svg" width="58" height="58"></object>
                </Link>
            </div>
